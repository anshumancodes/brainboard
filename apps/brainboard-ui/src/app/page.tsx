...
export default function Hero() {
  return (
    <main className="min-h-screen bg-[#071014] px-3 py-3 text-[#f4f1e9]">
      ...
      <div className="relative z-10 mx-auto mt-10 max-w-7xl px-6 pb-10 lg:px-10">
  <div className="rounded-2xl border border-white/10 bg-white/5 px-6 py-6 backdrop-blur-md sm:px-10 sm:py-7">
    <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 sm:gap-8">
        {[
          {
            title: "Real-time",
            description: "Changes sync instantly",
          },
          {
            title: "Multiplayer",
          ...
          {
            title: "Persistent",
            description: "Your boards stay saved",
          },
        ].map((item) => (
          <div key={item.title} className="flex items-start gap-3">
            <div className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-[#d9ff72]" />
            <div>
      ...
      <Link
        href="/signup"
        className="group flex shrink-0 items-center gap-2 rounded-full border border-[#d9ff72]/30 bg-[#d9ff72]/10 px-5 py-2.5 text-xs font-medium tracking-wide text-[#d9ff72] transition hover:bg-[#d9ff72]/20"
      >
        Start creating
        <ArrowUpRight
          size={13}
